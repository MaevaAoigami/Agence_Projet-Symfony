...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/p')) {
            // presentation
            if ($pathinfo === '/produit') {
                return array (  '_controller' => 'Agence\\AgenceBundle\\Controller\\ProduitsController::presentationAction',  '_route' => 'presentation',);
            }

            if (0 === strpos($pathinfo, '/panier')) {
                // panier
                if ($pathinfo === '/panier') {
                    return array (  '_controller' => 'AgenceBundle:Panier:panier',  '_route' => 'panier',);
                }
        ...
        // test
        if ($pathinfo === '/test') {
            return array (  '_controller' => 'Agence\\AgenceBundle\\Controller\\TestController::ajouterAction',  '_route' => 'test',);
        }
